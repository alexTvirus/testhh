...
<div class="post">
    ...
    <strong>ICQ :</strong></span> {{infoContact()->icq}}<br>
    <span style="color: #ff0000;"><strong>Telegram :</strong></span> {{ infoContact()->telegram }}<br>
    <span style="color: #ff0000;"><strong>Email :{{infoContact()->email}}</strong>
</div>
<div id="comment-area">
    <div id="comments">
        ...
        <div id="respond" class="comment-respond">
            ...
            <form method="POST" action="{{ action('CommentController@store') }}"  id="commentform" class="comment-form" enctype="multipart/form-data" novalidate="">
                @csrf
                <p class="comment-notes"><span id="email-notes">Your email address will not be published.</span> Required fields are marked <span class="required">*</span></p>
